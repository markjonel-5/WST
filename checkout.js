...
function placeOrder() {
    ...
    let finalCustomerName = currentUser ? `${currentUser.firstName} ${currentUser.lastName || ''}`.trim() : `${guestFName} ${guestLName}`.trim();
    ...
    // Sends the guest status to the success page URL
